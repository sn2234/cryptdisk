...
static const XtsTest aesXtsTestVectors[] =
{
	{
...
void DoAesXtsEncTest(const XtsTest& testData)
{
	...
	XtsSectorEncipher(cipherK1, cipherK2, testData.index, sizeof(testData.plaintext),
		testData.plaintext, tmp);
...
void DoAesXtsDecTest(const XtsTest& testData)
{
	...
	XtsSectorDecipher(cipherK1, cipherK2, testData.index, sizeof(testData.ciphertext),
		testData.ciphertext, tmp);
